          ...
          <v-list-item-content>
            <v-list-item-title class="d-flex align-center">
              ...
              >
                ...
                <v-icon
                  right
                  v-text="!panels.phrase ? 'lock' : 'lock_open'"
                />
              </v-btn>
            </v-list-item-title>
            <v-expand-transition>
          ...
          <v-list-item-content>
            <v-list-item-title class="d-flex align-center">
              ...
              >
                ...
                <v-icon
                  right
                  v-text="!panels.pk ? 'lock' : 'lock_open'"
                />
              </v-btn>
            </v-list-item-title>
            <v-expand-transition>
...
export default class Backup extends Vue {
  ...
  get color() {
    return (
      this.wallet.color || (this.$vuetify.theme.currentTheme.primary as string)
    );
  }
