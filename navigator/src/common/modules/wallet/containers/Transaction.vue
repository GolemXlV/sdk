<template>
  <Page>
    ...
    >
      ...
      <div
        class="text-center subtitle-1 my-1 mb-n1 white--text slightly-transparent"
      >
        {{ transaction.type }}
      </div>

      <v-list
        v-if="transaction.value"
        two-line
        subheader
        class="list--clean mb-n5"
      >
        <v-list-item>
    ...
    <PageContent>
      ...
      >
        <template
          v-if="transaction.type === 'send' || transaction.type === 'received'"
        >
          <v-list-item>
            <v-list-item-content class="overflow-initial">
              ...
              >
                <span
                  v-text="transaction.type === 'send' ? 'To' : 'From'"
                />
                <v-spacer />
                <v-btn
                  small
