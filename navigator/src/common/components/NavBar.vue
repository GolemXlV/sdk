<template>
  <div
    class="nav-bar"
    :class="{ 'no--shadow': $route.meta.noShadow }"
  >
    <v-speed-dial
      v-model="fab"
      :bottom="true"
      ...
      >
        ...
        <v-tab-item value="tab-list">
          ...
          <v-subheader class="wallet-selector mb-n4">
            ...
            >
              <template v-slot:activator="{ on }">
                <v-btn
                  icon
                  class="wallet-selector__menu-btn"
                  v-on="on"
                >
          ...
          <div>
            <div v-if="walletsInMenu.length < 1">
              <WalletSummary
                :wallet="null"
                @open="openWallet(null)"
              />
            </div>

            <div
              v-for="(wallet, i) of walletsInMenu"
              v-else
              :key="'sum-' + i"
            >
              <WalletSummary
        ...
        <v-tab-item value="tab-notifications">
          ...
          <v-container>
            ...
            <p
              v-else
              class="half-transparent text-center pa-3 pt-6"
            >
              No new notifications
            </p>

            <div
              v-for="notification of [...notificationsActive]
                .reverse()
                .slice(0, 30)"
            ...
            <div
              v-for="notification of [...notificationsHistory]
                .reverse()
                .slice(0, 30)"
