    ...
    <portal to="topbar">
      ...
      >
        <div v-if="showPortal">
          ...
          >
            <h2
              v-if="showValidation && validation.amount"
              class="group-label"
            >
            ...
            <div
              name="form-wallet"
              @click.stop="walletDialogOpen = true"
            >
              <TextField
                v-if="wallet"
                v-model="wallet.name"
                ...
                :dropdown="true"
                :addon="
                  wallet.balance | abbrNumber | uppercase | suffix(' GRAM')
                "
                @blur="touch"
              />
            </div>
            ...
            <h2
              v-if="showValidation && validation.image"
              class="group-label"
            >
